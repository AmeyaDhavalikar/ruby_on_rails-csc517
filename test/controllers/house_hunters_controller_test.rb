...
class HouseHuntersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create house_hunter" do
    assert_difference('HouseHunter.count') do
      post house_hunters_url, params: { house_hunter: { email: @house_hunter.email, name: @house_hunter.name, password: @house_hunter.password, phone: @house_hunter.phone, preffered_contact: @house_hunter.preffered_contact } }
    end
  ...
  test "should update house_hunter" do
    patch house_hunter_url(@house_hunter), params: { house_hunter: { email: @house_hunter.email, name: @house_hunter.name, password: @house_hunter.password, phone: @house_hunter.phone, preffered_contact: @house_hunter.preffered_contact } }

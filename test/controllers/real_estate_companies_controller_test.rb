...
class RealEstateCompaniesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create real_estate_company" do
    assert_difference('RealEstateCompany.count') do
      post real_estate_companies_url, params: { real_estate_company: { address: @real_estate_company.address, name: @real_estate_company.name, revenue: @real_estate_company.revenue, size: @real_estate_company.size, synopsis: @real_estate_company.synopsis, website: @real_estate_company.website, year_founded: @real_estate_company.year_founded } }
    end
  ...
  test "should update real_estate_company" do
    patch real_estate_company_url(@real_estate_company), params: { real_estate_company: { address: @real_estate_company.address, name: @real_estate_company.name, revenue: @real_estate_company.revenue, size: @real_estate_company.size, synopsis: @real_estate_company.synopsis, website: @real_estate_company.website, year_founded: @real_estate_company.year_founded } }
